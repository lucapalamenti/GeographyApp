 ...
 */
export const getMaps = async ( filter, sort, DESC ) => {
    ...
    query = query.concat( ";" );
    return await DBC.query( query, []).then( rows => {
 ...
 */
export const getMapById = async ( map_id ) => {
    if ( map_id ) {
 ...
 * @returns 
 */
export const deleteMap = async ( map_id ) => {
    await DBC.query(`
 ...
 */
export const deleteAllCustomMaps = async () => {
    await DBC.query(`
