...
INSERT INTO `shape` (`shape_id`, `shape_name`, `shape_points`) VALUES (1, 'Top Left', ST_GEOMFROMTEXT('MULTIPOLYGON(((0 0, 10 0, 10 10, 0 10, 0 0)),((20 20, 25 20, 25 25, 20 25, 20 20)))'));
INSERT INTO `shape` (`shape_id`, `shape_name`, `shape_points`) VALUES (2, 'Top Right', ST_GEOMFROMTEXT('MULTIPOLYGON(((0 0, 10 0, 10 10, 0 10, 0 0)),((20 20, 25 20, 25 25, 20 25, 20 20)))'));
